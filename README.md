...
> Текущий статус: ранняя публичная версия. Программа уже используется автором в реальной пакетной обработке, но перед массовым распространением желательно дополнительное тестирование на разных компьютерах.
...
При первом использовании модель загружается автоматически. Она не входит в репозиторий и не должна добавляться в Git.

## Системные требования

- Windows 10/11 x64;
- современный Python 3 для запуска исходников;
- NVIDIA GPU с совместимыми CUDA-драйверами;
